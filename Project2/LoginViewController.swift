...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func loginPressed() {
        ...
        let urlString: String = "http://condi.swu.ac.kr/student/M01/login/loginUser.php"
                ...
                if success == "YES" {
                    if let name = jsonData["name"] as? String {
                        DispatchQueue.main.async {
                            ...
                            let logoutViewController = storyboard.instantiateViewController(withIdentifier: "logoutView")
